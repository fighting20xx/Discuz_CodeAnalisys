...
0
|| checktplrefresh('./template/ubike_jia/home/space_home.htm', './template/default/home/space_header.htm', 1516937013, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/ubike_jia', 'home/space_home')
|| checktplrefresh('./template/ubike_jia/home/space_home.htm', './template/default/home/space_userabout.htm', 1516937013, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/ubike_jia', 'home/space_home')
|| checktplrefresh('./template/ubike_jia/home/space_home.htm', './template/ubike_jia/common/header_common.htm', 1516937013, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/ubike_jia', 'home/space_home')
|| checktplrefresh('./template/ubike_jia/home/space_home.htm', './template/default/home/space_diy.htm', 1516937013, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/ubike_jia', 'home/space_home')
|| checktplrefresh('./template/ubike_jia/home/space_home.htm', './template/default/home/space_header_personalnv.htm', 1516937013, 'diy', './data/template/2_diy_home_space_home.tpl.php', './template/ubike_jia', 'home/space_home')
;?>
...
<div id="ct" class="<?php if($_G['setting']['homestyle']) { ?>ct3_a<?php } else { ?>ct2_a<?php } ?> cl">
...
<div class="bm">
<div class="bm_c">
<div class="pbg mbn" style="height:16px;"><div class="pbr" style=" height:16px; width: <?php if($space['profileprogress'] < 2) { ?>2<?php } else { ?><?php echo $space['profileprogress'];?><?php } ?>%;"></div></div>
...
<?php if(empty($_GET['diy'])) { $_GET['diy'] = '';?><?php } if(!isset($topic)) { $topic = array();?><?php } ?>
    <link rel="stylesheet" type="text/css" href="template/ubike_jia/style/css/ubike.css" media="all">
    <script src="template/ubike_jia/style/js/jquery-u.js" type="text/javascript"></script>
    <script src="template/ubike_jia/style/js/jquery_uc.js" type="text/javascript"></script>
