...
0
|| checktplrefresh('./template/ubike_jia/common/header.htm', './template/ubike_jia/common/header_common.htm', 1516936539, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/ubike_jia', 'common/header_forum_forumdisplay')
;?>
...
<div class="wp"><?php echo adshow("headerbanner/wp a_h");?></div>
<div class="cl"></div>
...
<div id="ubike_topnav" class="nav_bar_box">
  <div class="nav_content wp cl">
    ...
    <div class="newnav_box" style="width:700px; float:left">
        <!--Start Navigation-->
        <?php $mnid = getcurrentnav();?>        <div id="ubike_menu_nav" class="ubike_m_n">
 ...
 <?php if($_G['uid']) { ?>
  ...
  <script src="template/ubike_jia/style/js/navtop.js" type="text/javascript"></script>
</div>
<?php } ?>
