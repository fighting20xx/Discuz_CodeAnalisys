...
0
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/common/seditor.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/common/upload.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
|| checktplrefresh('./template/ubike_jia/forum/viewthread.htm', './template/default/common/seccheck.htm', 1516936533, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/ubike_jia', 'forum/viewthread')
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><img src="template/ubike_jia/style/img/pn_post.png" alt="发新帖" /></a><?php } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复"><img src="template/ubike_jia/style/img/pn_reply.png" alt="回复" /></a>
<?php } ?>
...
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><img src="template/ubike_jia/style/img/pn_post.png" alt="发新帖" /></a>
<?php } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复"><img src="template/ubike_jia/style/img/pn_reply.png" alt="回复" /></a>
<?php } ?>
